...
exports.analyticsPackages = exports.analyticsEventMap
    .filter(function (pkg) { return pkg.test !== true; })
    .map(function (config) {
    var path = config.path;
    return path.substring(0, path.indexOf('/'));
});
exports.instrumentedComponents = exports.analyticsEventMap
    .filter(function (pkg) { return pkg.test !== true; })
    .reduce(function (acc, config) {
    var path = config.path;
    var packageSuffix = path.substring(0, path.indexOf('/'));
    var items = [];
    Object.keys(config.props).forEach(function (propName) {
        var components = config.derivatives
...
//# sourceMappingURL=AnalyticsEventMap.js.map