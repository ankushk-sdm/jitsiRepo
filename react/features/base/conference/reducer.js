...
const DEFAULT_STATE = {
    ...
    latestJoinedUser: undefined,
    latestLeftUser: undefined,
    trackStatus: 0
};
        ...
        case SET_START_MUTED_POLICY:
            ...
            case USER_LEFT:
                return {
                    ...state,
                    latestJoinedUser:undefined,
                    latestLeftUser: action.data
                }
            case TRACK_EVENT_CHANGE:
                return {
                    ...state,
                    trackStatus: state['trackStatus'] + 1
                }
        }
